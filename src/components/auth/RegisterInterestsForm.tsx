...
export default function RegisterInterestsForm({ onComplete }: RegisterInterestsFormProps) {
  // New state for education level. Null means not chosen yet.
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Update the user's profile with the selected subjects and interests.
      // (Here we assume the columns "subjects" and "interests" are both of type text[].)
