...
export function ChatInput({
    ...
    // Auto-resize the textarea when newMessage changes.
    useEffect(() => {
            ...
            {linkedMaterials.length > 0 && (
                <div className="mb-2 p-2 bg-gray-100 rounded-md flex flex-wrap gap-2">
                    {linkedMaterials.map((material, index) => (
                        <div
                            key={material.id}
                            className="p-2 bg-white rounded-lg shadow flex items-center gap-2"
                        >
            ...
            <div className="block sm:hidden flex flex-col gap-2">
                ...
                <div className="flex gap-2 items-center">
                    <textarea
                        ...
                        className="bg-gray-50 flex-1 p-2 border rounded resize-none overflow-hidden"
                        value={newMessage}
