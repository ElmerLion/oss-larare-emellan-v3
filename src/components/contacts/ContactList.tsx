  ...
  return (
    <div className="w-[400px] bg-white rounded-lg shadow-sm">
      <div className="p-4">
        ...
        <h2 className="text-sm text-gray-600 mb-4">Sök bland dina kontaker</h2>
        ...
        {filteredProfiles.length === 0 ? (
          <p className="flex items-center justify-center text-sm text-gray-500 h-full">Du har inga kontakter än.</p>
        ) : (
