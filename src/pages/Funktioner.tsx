...
export default function FeatureSection() {
    ...
    return (
        <>
            <Helmet>
                <title>
                    Hur funkar Oss Lärare Emellan? | Oss Lärare Emellan - Gemenskap för
                    Sveriges lärare
                </title>
                <meta
                    name="description"
                    content="Upptäck hur Oss Lärare Emellan fungerar: en plattform där lärare kan dela resurser, bygga nätverk och delta i samtal om undervisning. Förbättra din undervisning med vår community."
                />
                <meta
                    name="keywords"
                    content="lärare, undervisning, dela resurser, nätverk, utbildning, community, Sverige"
                />
                <link
                    rel="canonical"
            ...
            <div className="mt-16">
                ...
                <section
                    ref={ref}
                    className="py-20 bg-gradient-to-r from-sage-50 to-white"
                >
                    <div className="max-w-6xl mx-auto px-6">
                        ...
                        >
                            Hur funkar{" "}
                            <span className="text-[var(--ole-green)]">
                                Oss Lärare Emellan?
                            </span>
                        </motion.h2>
                        <div className="max-w-6xl mx-auto px-6 mt-8 text-center">
                            <p className="text-lg text-gray-700 leading-relaxed mb-4">
                                Lärare möter många utmaningar – tidspress, administrativa uppgifter
                                och konstant förändring i samhället. Det kan vara svårt att både
                                hitta inspirerande material och samarbeta med andra lärare.
                            </p>
