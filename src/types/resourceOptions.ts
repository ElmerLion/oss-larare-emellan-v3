...
export const courseSubjectOptionsForGymnasiet = [
  ...
  { value: "Redovisning", label: "Redovisning" },
  { value: "Biologi", label: "Biologi" },
  { value: "Kemi", label: "Kemi" },
  { value: "Fysik", label: "Fysik" },
  ...
  { value: "Industriteknik", label: "Industriteknik" },
  { value: "Bygg och anläggning", label: "Bygg och anläggning" },
  { value: "El- och energiteknik", label: "El- och energiteknik" },
  { value: "VVS- och fastighetsteknik", label: "VVS- och fastighetsteknik" },
  { value: "Transport", label: "Transport" },
  { value: "Fordonskunskap", label: "Fordonskunskap" },
  { value: "Flygteknik", label: "Flygteknik" },
  { value: "Maskinteknik", label: "Maskinteknik" },
  ...
  { value: "Omvårdnad", label: "Omvårdnad" },
  { value: "Moderna språk", label: "Moderna språk" },
  { value: "Teckenspråk", label: "Teckenspråk" },
  { value: "Mat och dryck", label: "Mat och dryck" },
  { value: "Livsmedels- och näringskunskap", label: "Livsmedels- och näringskunskap" },
  { value: "Turism och resor", label: "Turism och resor" },
  { value: "Hotell och konferens", label: "Hotell och konferens" },
  { value: "Ljudproduktion", label: "Ljudproduktion" },
  { value: "Film- och TV-produktion", label: "Film- och TV-produktion" },
  { value: "Journalistik", label: "Journalistik" },
  { value: "Medieproduktion", label: "Medieproduktion" },
  { value: "Samiska", label: "Samiska" }
];
